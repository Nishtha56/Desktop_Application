...
class my_cust_PDF(FPDF):
    def header(self):
        self.set_text_color(255, 116, 158 )
    ...
    def chapter_content(self,data,headings):
        ...
        spacing=1
        col_width = self.w /(total+1)   # 9 = no of columns +1 to adjust columns to screen
...
if __name__ == '__main__':
    pdf = my_cust_PDF()
    data=[['Reg_No', 'Name', 'Phone No ', 'UID', 'Check_In', 'Check_Out', 'Total_guests'],
          ['Reg_No', 'Name', 'Phone No ', 'UID', 'Check_In', 'Check_Out', 'Total_guests'],
          ['Reg_No', 'Name', 'Phone No ', 'UID', 'Check_In', 'Check_Out', 'Total_guests']]

    headings = ['Reg_No', 'Name', 'Phone No ', 'UID', 'Check_In', 'Check_Out', 'Total_Guest']
